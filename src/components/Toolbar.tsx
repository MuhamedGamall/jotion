  ...
  return (
    <div className="pl-[54px] group relative mt-16">
      {!!initialData.icon && !preview && (
        <div className="flex gap-x-2 items-center group/icon pt-6 absolute left-[10%] -top-[125px]">
      ...
      {!!initialData.icon && preview && (
        <p className="text-6xl pt-6 absolute left-[10%] -top-[125px]">
          {initialData.icon}
        </p>
      )}
      ...
      {isEditing && !preview ? (
        <TextAreaAutoSize
          className="text-5xl w-fit bg-transparent font-bold break-words outline-none text-[#3F3F3F] dark:text-[#CFCFCF]
        resize-none"
          ref={inputRef}
          onBlur={disableInput}
          onKeyDown={onKeyDown}
